...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isOverdue: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    taskUid: Schema.Attribute.UID<'title'>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    userTasks: Schema.Attribute.Relation<'oneToMany', 'api::task.task'>;
  };
}
